...
<details open>
<summary><strong>Scheduled Teaching in Public Policy (UNC-CH)</strong></summary>

**The Politics of Public Policy**

Public policy does not end with the passage of legislation. While policy design often attracts the most attention, the implementation phase—where political decisions are translated into administrative action—frequently unfolds in relative silence. This course seeks to unveil that curtain. It examines how **political institutions**, **political behavior**, and **bureaucratic politics** shape the ways policies are interpreted, delivered, and experienced in practice.

Building on both classical and recent scholarship in political science and public administration, the course re-centers implementation as a political process. Rather than treating it as a technical afterthought, we explore how administrative burdens—the learning, compliance, and psychological costs of interacting with the state—are produced through a layered architecture of policy design, bureaucratic discretion, and frontline decision-making. This perspective highlights how implementation failures are not merely managerial breakdowns but reflect broader institutional and political dynamics.

Students analyze three interrelated dimensions of policy implementation:

- **Political institutions**, including federalism, separation of powers, and administrative procedures  
- **Political behavior**, such as public opinion, policy framing, and participation  
- **Bureaucratic politics**, including agency discretion, frontline decision-making, and administrative capacity  

Special attention is paid to how inequality is reproduced or contested through everyday encounters with the state, and how implementation challenges can be addressed through better design, coordination, and accountability mechanisms.

The course adapts to different levels of study:

- For **undergraduates**, it introduces foundational concepts and real-world cases that reveal the political significance of implementation. Case studies will draw on contemporary issues in health, welfare, education, and digital service delivery.
- For **Master of Public Policy (MPP) students**, it emphasizes applied analysis and equips students with conceptual and diagnostic tools to assess and navigate implementation challenges across government systems.
- For **PhD students**, the course engages deeply with theoretical and empirical literature on administrative burden, political institutions, and street-level governance. Doctoral students will use a macro–meso–micro framework to develop original research questions and contribute to scholarly debates on the politics of implementation.
...
![](https://static.cambridge.org/binary/version/id/urn:cambridge.org:id:binary:20240115022931608-0277:S1049096523000732:S1049096523000732_tab1.png)
