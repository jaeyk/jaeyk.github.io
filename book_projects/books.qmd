...
The book draws on extensive archival research, administrative records, and digital trace data, and combines qualitative, quantitative, and computational methods. Using comparative historical analysis across cities, racial groups, and national contexts, it shows that panethnic identities, or race-based coalition formations, were not automatic reactions to racial discrimination. Rather, they emerged through strategic adaptation to the classificatory logics and incentive structures of the modern administrative state.
...
1. ["How to Use University: Learning How to Learn and Why It Matters for a Fulfilling Career (in Korean)"](https://www.yes24.com/product/goods/183755163) (Sejong Books, 2nd ed., 2026) [[book substack](https://learn2career.substack.com/)]
