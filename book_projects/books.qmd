...
By centering policy implementation, local political economy, and classification cost, *Unseen and Uncounted* reframes racial group formation as a process of institutional co-production. In doing so, it extends theories of administrative burden by showing how burdens operate not only at the individual level but also at the group level. Whereas administrative burden refers to the costs individuals face when interacting with the state, classification cost captures the costs government agencies face in acquiring and organizing knowledge about their target populations.
