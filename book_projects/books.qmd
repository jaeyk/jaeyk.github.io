...
Drawing on original data from both local administrators and community organizers, the book traces the development of policies governing diverse low-income populations at the subnational, national, and transnational levels during the postwar period of American political development. Governing diversity is challenging for both administrative and political reasons, and these challenges are inherently connected. Classifying diverse groups is costly, and as such, ambiguously defined target groups have a strong incentive to create new forms of political representation and articulate new demands.
