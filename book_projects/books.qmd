...
Drawing on original data from both local administrators and community organizers, the book traces the development of policies governing diverse low-income populations at the subnational, national, and transnational levels during the postwar period of American political development. Governing diversity is challenging for both administrative and political reasons, and these challenges are inherently connected. Classifying diverse groups is costly, and as such, target groups have a strong incentive to create new forms of political representation and articulate new demands. Race is socially constructed, but how it is constructed varies across contexts. Administrative race is a construction of race that emerged from negotiations between administrators and communities.
...
2. **"Burdens, Profits, and People Power: Inequality and Resistance in the American AI Contracting State."**



<details>

<summary><strong>Korean Books</strong></summary>

1. **"We Need Civic Data: How Public Data Can Fail Us, and How It Can Build a More Just Society"** (in Korean, [Sejong Books](http://www.sejongbooks.co.kr/?act=board.index&bbs_code=sub2_1&sc=bbs_title&ss=%EC%9A%B0%EB%A6%AC%EC%97%90%EA%B2%8C%EB%8A%94&page=1&bbs_mode=view&bbs_seq=160), 2023) \[[book website](https://wethedata.vercel.app/)\]
...
2. **"How to Use University: Learning How to Learn and Why It Matters for a Fulfilling Career"** (in Korean, Sejong Books, 2nd ed., 2026) [[book website](https://learn2career.vercel.app/)]
