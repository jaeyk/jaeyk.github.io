...
1. ["How to Use University: Learning How to Learn and Why It Matters for a Fulfilling Career (in Korean)"](https://ebook-product.kyobobook.co.kr/dig/epd/sam/E000003198821) (Sejong Books, 2nd ed. forthcoming) [[book substack](https://learn2career.substack.com/)]

Why do so many students enter college full of ambition, only to graduate with more confusion than clarity?

*How to Use University* is a practical guide to navigating college with purpose. Organized around four core themes, exploring college, learning, career, and life, it helps students shift from passive schooling to intentional, opportunity-driven learning. The book encourages students to treat the university as a **launchpad** for discovering interests, initiating projects, and building community. It emphasizes a key idea: unlocking even one small opportunity, especially a self-initiated project, can set off a **cycle of opportunities** that grows over time. With its structured framework, practical strategies, and ethos of public leadership, this book has become a trusted companion for Korean college students, exposing a **hidden transcript** centered on agency, initiative, and continuous learning.
