...
Hello! I am a senior data scientist at [Code for America](https://codeforamerica.org/) and a research fellow at [the SNF Agora Institute at Johns Hopkins University](https://snfagora.jhu.edu/person/jae-yeon-kim/). I have a Ph.D. in political science from UC Berkeley, where I was a senior data science fellow at D-Lab. Since 2020, I have been working on the Mapping Modern Agora project (incubated at the SNF Agora) that utilizes big data and machine learning to map the U.S. civil society at scale. Prior to joining Code for America, I was an assistant professor of data science at the KDI School of Public Policy and Management in South Korea.

## Research agenda

My research is situated at the intersection of political science, public policy, and data science. I employ computational, experimental, survey, and archival methods to investigate how marginalized individuals build power, resist social inequality, and access public benefits. In addition, I study the variation of anti-immigrant politics and its resistance, as well as the political patterns of online harm and digital inequality. My objective is to enhance the effectiveness and equity of civic engagement and policy implementation by utilizing the best available social science, data, and methods. My research focuses primarily on the United States, Canada, and East Asia.
