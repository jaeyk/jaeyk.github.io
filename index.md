...
My research focuses on urban and local politics, identity politics, civic engagement, and policy implementation in the United States, Canada, and East Asia. I investigate how political institutions, historical legacies, and social geography shape the lived experience of marginalized people and how they collectively respond to such barriers. Additionally, I am interested in using big data and machine learning to map the geography of civic inequality in the US and other countries. I frequently collaborate with government agencies, such as the state governments of California, New York, Colorado, and New Mexico, to design human-centered technology interventions that reduce the administrative burdens in safety net programs.
